...
```markdown
Read C:/scratchpad/nozar/.opencode/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/scratchpad/nozar/.opencode/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/scratchpad/nozar/.opencode/agents/gsd-ui-checker.md for instructions.
