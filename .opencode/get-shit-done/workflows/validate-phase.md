...
```
Agent(
  prompt="Read C:/scratchpad/nozar/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/scratchpad/nozar/.opencode/get-shit-done/templates/VALIDATION.md`
