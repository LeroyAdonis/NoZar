...
<required_reading>
@C:/scratchpad/nozar/.opencode/get-shit-done/references/ai-frameworks.md
@C:/scratchpad/nozar/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/scratchpad/nozar/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/scratchpad/nozar/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/scratchpad/nozar/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/scratchpad/nozar/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/scratchpad/nozar/.opencode/agents/gsd-eval-planner.md for instructions.
