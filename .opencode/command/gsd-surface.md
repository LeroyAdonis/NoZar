...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/scratchpad/nozar/.opencode/.gsd-surface.json`
(sibling to `C:/scratchpad/nozar/.opencode/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/scratchpad/nozar/.opencode/skills/gsd-*/`.
...
(`~/.config/opencode`), NOT the skills sub-directory (`C:/scratchpad/nozar/.opencode/skills`).
...
`C:/scratchpad/nozar/.opencode/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/scratchpad/nozar/.opencode/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/scratchpad/nozar/.opencode/.gsd-surface.json`
Install profile marker: `C:/scratchpad/nozar/.opencode/.gsd-profile`
Skill dirs: `C:/scratchpad/nozar/.opencode/skills/gsd-*/`
Engine module: `C:/scratchpad/nozar/.opencode/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/scratchpad/nozar/.opencode/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
