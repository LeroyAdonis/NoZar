...
<reference>
@C:/scratchpad/nozar/.opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/scratchpad/nozar/.opencode/get-shit-done/references/user-profiling.md` to load:
