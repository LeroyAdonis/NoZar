...
<required_reading>
@C:/scratchpad/nozar/.opencode/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/scratchpad/nozar/.opencode/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/scratchpad/nozar/.opencode
                  → checks C:/scratchpad/nozar/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/scratchpad/nozar/.opencode/get-shit-done
                  → writes to C:/scratchpad/nozar/.opencode/get-shit-done/hooks/
...
@C:/scratchpad/nozar/.opencode/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/scratchpad/nozar/.opencode/get-shit-done/references/common-bug-patterns.md
