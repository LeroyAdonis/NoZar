...
Use template from `C:/scratchpad/nozar/.opencode/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/scratchpad/nozar/.opencode/get-shit-done/templates/UI-SPEC.md`
