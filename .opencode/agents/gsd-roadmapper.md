...
Reference full template: `C:/scratchpad/nozar/.opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/scratchpad/nozar/.opencode/get-shit-done/templates/state.md`.
