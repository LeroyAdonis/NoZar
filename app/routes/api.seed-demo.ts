...
export async function action({ request }: { request: Request }) {
  ...
  const PH: Record<string, string[]> = {
    ...
    j1: ["1506439774525-24e6e1b5e3f1","1519941626720-1010fdb4c59c","1555041469-a586c61ea9bc"],
    j2: ["1505740420928-0f84d1fb5c7a","1583394833516-0d0e7e2e77d9","1533745841966-2c9e1b10b1f3"],
    j3: ["1600268381982-6e5ff7394de2","1504672234303-f1b0ef11e18a","1598892343161-f96abe14e732"],
    j4: ["1504148456987-46e22be7fb5d","1581094796770-f5c9c4c4a3c4","1516565433493-0c3d07e92b7a"],
  };
