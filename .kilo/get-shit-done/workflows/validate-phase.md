...
```
Agent(
  prompt="Read C:/scratchpad/nozar/.kilo/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/scratchpad/nozar/.kilo/get-shit-done/templates/VALIDATION.md`
