...
<template>
@C:/scratchpad/nozar/.kilo/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/scratchpad/nozar/.kilo/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/scratchpad/nozar/.kilo/get-shit-done/workflows/transition.md`.
...
- Follow @C:/scratchpad/nozar/.kilo/get-shit-done/workflows/diagnose-issues.md
