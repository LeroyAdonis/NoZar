...
<required_reading>
@C:/scratchpad/nozar/.kilo/get-shit-done/references/ai-frameworks.md
@C:/scratchpad/nozar/.kilo/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/scratchpad/nozar/.kilo/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/scratchpad/nozar/.kilo/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/scratchpad/nozar/.kilo/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/scratchpad/nozar/.kilo/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/scratchpad/nozar/.kilo/agents/gsd-eval-planner.md for instructions.
