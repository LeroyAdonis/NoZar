...
```bash
INIT=$(node "C:/scratchpad/nozar/.kilo/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/scratchpad/nozar/.kilo/get-shit-done/templates/spec.md.
