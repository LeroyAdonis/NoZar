...
```markdown
Read C:/scratchpad/nozar/.kilo/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/scratchpad/nozar/.kilo/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/scratchpad/nozar/.kilo/agents/gsd-ui-checker.md for instructions.
