...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/scratchpad/nozar/.kilo/.gsd-surface.json`
(sibling to `C:/scratchpad/nozar/.kilo/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/scratchpad/nozar/.kilo/skills/gsd-*/`.
...
(`~/.config/kilo`), NOT the skills sub-directory (`C:/scratchpad/nozar/.kilo/skills`).
...
`C:/scratchpad/nozar/.kilo/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/scratchpad/nozar/.kilo/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/scratchpad/nozar/.kilo/.gsd-surface.json`
Install profile marker: `C:/scratchpad/nozar/.kilo/.gsd-profile`
Skill dirs: `C:/scratchpad/nozar/.kilo/skills/gsd-*/`
Engine module: `C:/scratchpad/nozar/.kilo/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/scratchpad/nozar/.kilo/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
