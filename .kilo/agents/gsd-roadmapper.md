...
Reference full template: `C:/scratchpad/nozar/.kilo/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/scratchpad/nozar/.kilo/get-shit-done/templates/state.md`.
