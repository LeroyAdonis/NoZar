...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/scratchpad/nozar/.hermes/.gsd-surface.json`
(sibling to `C:/scratchpad/nozar/.hermes/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/scratchpad/nozar/.hermes/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/scratchpad/nozar/.hermes/skills`).
...
`C:/scratchpad/nozar/.hermes/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/scratchpad/nozar/.hermes/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/scratchpad/nozar/.hermes/.gsd-surface.json`
Install profile marker: `C:/scratchpad/nozar/.hermes/.gsd-profile`
Skill dirs: `C:/scratchpad/nozar/.hermes/skills/gsd-*/`
Engine module: `C:/scratchpad/nozar/.hermes/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/scratchpad/nozar/.hermes/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
