...
Use template from `C:/scratchpad/nozar/.hermes/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/scratchpad/nozar/.hermes/get-shit-done/templates/UI-SPEC.md`
