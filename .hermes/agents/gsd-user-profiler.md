...
<reference>
@C:/scratchpad/nozar/.hermes/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/scratchpad/nozar/.hermes/get-shit-done/references/user-profiling.md` to load:
