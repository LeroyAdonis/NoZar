...
<required_reading>
@C:/scratchpad/nozar/.hermes/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/scratchpad/nozar/.hermes/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/scratchpad/nozar/.hermes
                  → checks C:/scratchpad/nozar/.hermes/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/scratchpad/nozar/.hermes/get-shit-done
                  → writes to C:/scratchpad/nozar/.hermes/get-shit-done/hooks/
...
@C:/scratchpad/nozar/.hermes/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/scratchpad/nozar/.hermes/get-shit-done/references/common-bug-patterns.md
