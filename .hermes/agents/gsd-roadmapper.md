...
Reference full template: `C:/scratchpad/nozar/.hermes/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/scratchpad/nozar/.hermes/get-shit-done/templates/state.md`.
