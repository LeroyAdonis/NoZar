...
```bash
INIT=$(node "C:/scratchpad/nozar/.hermes/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/scratchpad/nozar/.hermes/get-shit-done/bin/gsd-tools.cjs" commit \
