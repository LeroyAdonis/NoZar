...
INSTALL_JS_GLOBAL="C:/scratchpad/nozar/.hermes/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/scratchpad/nozar/.hermes/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
