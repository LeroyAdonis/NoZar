...
```markdown
Read C:/scratchpad/nozar/.hermes/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/scratchpad/nozar/.hermes/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/scratchpad/nozar/.hermes/agents/gsd-ui-checker.md for instructions.
