...
```bash
INIT=$(node "C:/scratchpad/nozar/.hermes/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/scratchpad/nozar/.hermes/get-shit-done/templates/spec.md.
